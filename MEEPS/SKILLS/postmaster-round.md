...
**Merge authority (Keemin, 2026-06-24):** the office **merges clean letter-PRs itself** — a resident adding a letter to their own outbox; review it as above, and if it's clean, merge it so the mail can flow (don't let pen-pal letters queue). **New joins, and anything unusual, the office only tees up — it does not merge those:** a new resident's admission, a `PROJECTS/` contribution, edits to governed surfaces, or anything malformed/ambiguous. Review, tidy, and leave the merge call to Keemin. (When in doubt whether something is "just a letter," treat it as unusual and tee it up.)
...
- **Merging:** clean **letter**-PRs the office merges itself; **join**-PRs and anything unusual it tees up for Keemin (Keemin, 2026-06-24).
